    ...
    var body: some View {
        VStack(spacing: 0) {
            Picker("", selection: $selectedTab) {
                ...
                Label("考題", systemImage: "checklist").tag(1)
                Label("資料庫", systemImage: "cylinder.split.1x2").tag(2)
                Label("設定", systemImage: "gearshape").tag(3)
                Label("歷史", systemImage: "clock").tag(4)
            }
